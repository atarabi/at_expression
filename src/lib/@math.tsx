({
    load(): Atarabi.math.Lib {
        ...
        class Vector implements Atarabi.math.Vector {
            ...
            static isVector(v: any): v is Vector {
                return v instanceof Vector;
            }
        }

        class Matrix implements Atarabi.math.Matrix {
            constructor(
            ...
            static scale(sx: number, sy = sx): Matrix {
                return new Matrix([
                    sx, 0, 0,
                    0, sy, 0,
                    0, 0, 1
            ...
            static rotate(rad: number): Matrix {
            ...
            static skew(ax: number, ay: number): Matrix {
                return new Matrix([
                    1, Math.tan(ax), 0,
                    Math.tan(ay), 1, 0,
                    0, 0, 1
            ...
            static fromLayerTransform(layer: Layer): Matrix {
            ...
            static isMatrix(m: any): m is Matrix {
