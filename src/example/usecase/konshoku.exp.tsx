...
const Font = footage("@font.lib.jsx").sourceData.load();
...
const pseudo = Effect.Pseudo("Konshoku")
    ...
    // Alphabet
    .groupStart("Alphabet")
    .popup("Alphabet Font", 1, fonts)
    .percent("Alphabet Font Size", 100, 0, 1000, 0, 200)
    .color("Alphabet Color", { red: 255, green: 255, blue: 255 })
    .groupEnd()
    .create();
...
TextStyle({
    ...
    .rule(CharClass.Latin, {
        font: fonts[pseudo("Alphabet Font").value - 1],
        fontSize: pseudo("Font Size").value * pseudo("Alphabet Font Size").value / 100,
        fillColor: pseudo("Alphabet Color").value.slice(0, 3) as [number, number, number],
    })
    .apply();